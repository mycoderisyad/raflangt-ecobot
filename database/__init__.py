...
from .models.waste_classification import (
    WasteClassificationModel as _WasteClassificationModel,
)
...
class UserModel:
    ...
    def __init__(self, db_manager=None):
        if db_manager is None:
            ...
            self._db_manager = (
                ...
                if hasattr(db_manager, "_db_manager")
                else db_manager
            )
    ...
    def update_user_role(
        self, phone_number: str, new_role: str, admin_phone: str = None
    ) -> bool:
...
class WasteClassificationModel:
    ...
    def save_classification(
        ...
        if classification_result:
            # New format
            return self._model.save_classification(
                user_phone, image_data, classification_result
            )
        else:
            # Legacy format
            legacy_result = {
            ...
            return self._model.save_classification(
                user_phone, image_data or b"", legacy_result
            )
...
class UserInteractionModel:
    ...
    def log_interaction(
        ...
        return self._model.log_interaction(
            user_phone,
            interaction_type,
            message_content,
            response_content,
